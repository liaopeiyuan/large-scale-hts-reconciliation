...
def main():
    ...
    start = timer()
    rec = lhts.reconcile_sparse_algo("middle_out", S_compact, 30490, 33549, 4, yhat, level_2_p, 2, 0.0)
    end = timer()
    ...
    start = timer()
    rec2 = lhts.reconcile_sparse_matrix("middle_out", S_compact, 30490, 33549, 4, yhat, level_2_p, 2, 0.0)
    end = timer()
    elapsed = round(end - start, 4)
    ...
    """
    start = timer()
    rec = lhts.reconcile_sparse_algo("bottom_up", S_compact, 30490, 33549, 4, yhat, top_down_p, -1, 0.0)
    end = timer()
    elapsed = round(end - start, 4)
    print("Bottom up (algo): ", str(elapsed), " ", lhts.smape(rec, gt))

    print(np.abs(yhat[:30490,-1:] - rec[:30490,-1:]).sum())
    print(np.abs(yhat[30490:,-1:] - rec[30490:,-1:]).sum())

    start = timer()
    rec2 = lhts.reconcile_sparse_matrix("bottom_up", S_compact, 30490, 33549, 4, yhat, top_down_p, -1, 0.0)
    end = timer()
    elapsed = round(end - start, 4)
    ...
    start = timer()
    rec = lhts.reconcile_sparse_algo("top_down", S_compact, 30490, 33549, 4, yhat, top_down_p, -1, 0.0)
    end = timer()
    elapsed = round(end - start, 4)
    ...
    start = timer()
    rec2 = lhts.reconcile_sparse_matrix("top_down", S_compact, 30490, 33549, 4, yhat, top_down_p, -1, 0.0)
    end = timer()
    elapsed = round(end - start, 4)
    ...
    start = timer()
    rec = lhts.reconcile_sparse_algo("OLS", S_compact, 30490, 33549, 4, yhat, top_down_p, 0, 0.0)
    end = timer()
    elapsed = round(end - start, 4)
    ...
    start = timer()
    rec = lhts.reconcile_sparse_algo("WLS", S_compact, 30490, 33549, 4, yhat, top_down_p, 0, 0.5)
    end = timer()
    elapsed = round(end - start, 4)
